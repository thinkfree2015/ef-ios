...
import {styles as styles0,Header,IconDiscuss,IconPayment} from './../common/styles';
import {TopImg,HeadMaster,TitleBar,DiscussMod,ProgressBar,ArtworkDetails,AuctionRecord,StickyBottom} from './../common/business';
                ...
                <ScrollView style={{height:500}}>
                    ...
                    <View style={[styles0.row,styles0.p12,styles0.topbor,styles0.btmbor]}>
                            <View style={[styles0.center,styles0.vertical,styles.pm_qp]}>
                                <Text style={styles0.black}>
                                    <Text style={styles0.fz10}>成交价：</Text>
                                    <Text style={styles0.fz12}>2000元</Text>
                                </Text>
                            </View>
                            <View style={[styles0.center,styles0.vertical,styles0.bg0,styles.pm_time]}>
                                <View style={[styles0.row,styles0.vertical,styles0.center]}>
                                    <Text style={[styles0.white,styles0.fz10]}>拍卖结束</Text>
                                    <Text style={[styles0.white,styles0.fz12,styles0.ml12,styles0.mr12]}>恭喜</Text>
                                    <Text style={[styles0.white,styles0.fz12]}>三毛猫</Text>
                                </View>
                            </View>
                        </View>
                    {/*大师头像、名字、描述*/}
                    ...
                    <View style={[styles0.pl12,styles0.pr12,styles0.mb12,styles0.btmbor]}>
                            ...
                            <View style={[styles0.mt6]}>
                                <View style={[styles0.center,styles0.vertical]}>
                                    <Text style={[styles0.fz12,styles0.black]}>
                                        <Text>恭喜</Text>
                                        <Text style={styles0.fz15}> 三毛猫 </Text>
                                        <Text>拍得作品</Text>
                                    </Text>
                                </View>
                                <View style={[styles0.row]}>
                                    <View style={[styles0.flex,styles0.right,styles0.pr12]}><Text style={[styles0.fz12,styles0.black]}>成交金额： 200000 元</Text></View>
                                    <View style={[styles0.flex,styles0.left,styles0.pl12]}><Text style={[styles0.fz12,styles0.black]}>参拍人数： 1000 人</Text></View>
                                </View>

                                <TouchableOpacity style={[styles0.center,styles0.mt6,styles.des_select]} >
