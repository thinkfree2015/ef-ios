...
import {styles as styles0,Header,IconDiscuss} from './../common/styles';
            ...
            <View style={styles0.flex}>
                ...
                <ScrollView style={{height:500}}>
                    ...
                    <View style={[styles0.row,styles0.p12,styles0.topbor,styles0.btmbor]}>
                            ...
                            <View style={[styles0.center,styles0.vertical,styles0.bg0,styles.pm_time]}>
                                <View style={[styles0.row,styles0.vertical,styles0.center]}>
                                    ...
                                    <Text style={[styles0.white,styles0.fz12,styles0.ml12,styles0.mr12]}>即将开奖</Text>
                    ...
                    <View style={[styles0.pl12,styles0.pr12,styles0.mb12,styles0.btmbor]}>
                            ...
                            <View style={[styles0.mt6,styles0.pb12,styles0.center]}>
                                <View style={[styles0.vertical,styles.pmr_text]}><Text style={[styles0.fz12,styles0.black]}>作品已流拍</Text></View>
                                <View style={[styles0.vertical,styles.pmr_text]}><Text style={[styles0.fz12,styles0.black]}>将在投资者中抽出一位幸运者，送出作品</Text></View>
                                <View style={[styles0.row,styles0.center,styles0.vertical,styles.pmr_text]}>
                                    <Text style={[styles0.fz12,styles0.black]}>抽奖日期  </Text>
                                    <Text style={[styles0.fz12,styles0.black]}>2016-03-20  19:00:00</Text>
                                </View>
                            </View>
